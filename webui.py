...
CMD_FLAGS = '--chat --share --api --listen-port 6005 --trust-remote-code --extensions openai --model OpenBuddy_openbuddy-falcon-7b-v5-fp16 --auto-devices --load-in-4bit --use_double_quant --quant_type nf4 --lora json_reader'
